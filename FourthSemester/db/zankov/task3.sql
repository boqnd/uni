...
----------------------------------------------------
--Въпрос 3:От следващата таблица напишете SQL заявка, за да намерите онези служители, които работят като същото обозначение на Janet. Върнете пълна информация за служителите.
