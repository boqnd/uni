...
----------------------------------------------------
--Въпрос 6:Напишете SQL заявка, за да намерите служителите, чиито заплати са по-големи от средните заплати на всички служители в отдела 'Treasury'.
----------------------------------------------------
...
--------вашето решение-------------------
select * from EMPLOYEES where Salary > (select AVG(Salary) as avgS from EMPLOYEES where dnum = (Select dept_codes from DEPARTMENTS where Departments = 'Treasury')
);
----------------------------------
