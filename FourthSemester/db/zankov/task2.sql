...
----------------------------------------------------
--Въпрос 2:Напишете SQL заявка, за да покажете имената на служителите или техните ръководители.
--Уверете се, че имената са подредени едно след друго и в колонна форма от таблицата на служителите?
...
Select E.FirstName, E.LastName, M.FirstName as Manager from EMPLOYEES E JOIN EMPLOYEES M ON M.EmployeeID = E.Manager
