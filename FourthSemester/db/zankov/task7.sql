...
----------------------------------------------------
--Въпрос 7:Напишете SQL заявка, за да получите информация за служителите, които работят по всички проекти, намиращи се в град   'Plovdiv'.
----------------------------------------------------
...
--------вашето решение--------------------
SELECT * from EMPLOYEES where EmployeeID in (SELECT EmployeeID from WORK where WORK.Pnumber in (select Pnumber from PROJECTS where Location = 'Plovdiv')
);
----------------------------------
