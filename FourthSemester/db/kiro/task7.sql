...
--3 Дата на изпита:
----------------------------------------------------
--Въпрос 7: От следващата таблица напишете SQL заявка, за да намерите онези служители, чийто мениджър е с първо име = Andrew.
--Върнете пълна информация за служителите.
...
Select E.FirstName, E.LastName, M.FirstName as Manager from EMPLOYEES E JOIN EMPLOYEES M ON M.EmployeeID = E.Manager WHERE M.FirstName = 'Andrew';
