...
--Въпрос 4: Напишете SQL заявка, която връща името на проекта, отработените часове и номера на проекта за всички работи върху записи, където часове > 30.
----------------------------------------------------
...
select P.Pnumber, P.Pname, W.hours from PROJECTS P Join (select Pnumber, SUM(hours) as hours from WORK group by Pnumber) W on P.Pnumber = W.Pnumber WHERE W.hours > 30;
