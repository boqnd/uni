...
--3 Дата на изпита:
----------------------------------------------------
--Въпрос 1:От следващата таблица напишете SQL заявка, за да изчислите общата заплата на обозначението DEVELOPER. Връщане на общата заплата.
----------------------------------------------------
...
Select SUM(Salary) from EMPLOYEES where Position = 'DEVELOPER';
