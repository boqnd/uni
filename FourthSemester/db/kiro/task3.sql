...
--3 Дата на изпита:
----------------------------------------------------
--Въпрос 3:От следващата таблица напишете SQL заявка, за да намерите онези служители, които работят като същото обозначение на ANDREW. Върнете пълна информация за служителите.
