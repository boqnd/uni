...
--3 Дата на изпита:
----------------------------------------------------
--Въпрос 2:От следващата таблица напишете SQL заявка, за да изчислите общата заплата на служителите от отдел 3. Върнете общата заплата.
----------------------------------------------------

use master
go
DROP DATABASE IF EXISTS въпрос_2;
go
create database
въпрос_2
go
...
Select SUM(Salary) from EMPLOYEES where dnum = 3;
