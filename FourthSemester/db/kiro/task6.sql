...
--3 Дата на изпита:
----------------------------------------------------
--Въпрос 6:От следващата таблица напишете SQL заявка, за да намерите онези служители, които не работят в отдел Defense.
...
select * from EMPLOYEES where dnum = (Select dept_codes from DEPARTMENTS where Departments = 'Defense');
