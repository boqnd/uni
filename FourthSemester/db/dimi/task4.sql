...
--Въпрос 4:От следващата таблица напишете SQL заявка, за да намерите онези служители, чиято заплата е повече от заплатата на Robert.
--Върнете пълна информация за служителите.
----------------------------------------------------

use master
go
DROP DATABASE IF EXISTS въпрос_4;
go
create database
въпрос_4
go
...
SELECT * from EMPLOYEES where Salary > (select Salary as StSalary from EMPLOYEES where FirstName = 'Robert');
