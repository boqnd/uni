...
----------------------------------------------------
--Въпрос 1:--Напишете SQL заявка, за да намерите онези служители, които не принадлежат към отдела 4. Върнете пълна информация за служителите.
----------------------------------------------------
...
SELECT * FROM EMPLOYEES WHERE dnum <> 1;
