...
-----------------------------------------------------
--1 Пълните имена на студента: Димитриос Савваидис
--2 Факултетен номер: 9EB0700069
--3 Дата на изпита: 26.05.2022
----------------------------------------------------
--Въпрос 7:Напишете SQL заявка, за да получите информация за служителите, които работят по всички проекти, намиращи се в град   'Sofia'.
----------------------------------------------------

use master
go
DROP DATABASE IF EXISTS въпрос_7;
go
create database
въпрос_7
go
...
GO
/****** Object:  Table [dbo].[EMPLOYEES]    Script Date: 24.5.2022 г. 19:44:04 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PROJECTS]    Script Date: 24.5.2022 г. 19:44:04 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[WORK]    Script Date: 24.5.2022 г. 19:44:04 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[DEPARTMENTS] ([dept_codes], [Departments], [date_created], [Annual budget], [Field5]) VALUES (1, N'Treasury', N'September 2, 1789', NULL, N'$16.55 billion')
INSERT [dbo].[DEPARTMENTS] ([dept_codes], [Departments], [date_created], [Annual budget], [Field5]) VALUES (2, N'Defense', N'September 18, 1947', NULL, N'$716 billion')
INSERT [dbo].[DEPARTMENTS] ([dept_codes], [Departments], [date_created], [Annual budget], [Field5]) VALUES (3, N'Justice', N'July 1, 1870', NULL, N'$33.2 billion')
INSERT [dbo].[DEPARTMENTS] ([dept_codes], [Departments], [date_created], [Annual budget], [Field5]) VALUES (4, N'Interior', N'March 3, 1849', NULL, N'$21.55 billion')
INSERT [dbo].[DEPARTMENTS] ([dept_codes], [Departments], [date_created], [Annual budget], [Field5]) VALUES (5, N'Agriculture', N'May 15, 1862', N'1,51e+11', N'$151 billion')
INSERT [dbo].[DEPARTMENTS] ([dept_codes], [Departments], [date_created], [Annual budget], [Field5]) VALUES (6, N'Commerce', N'February 14, 1903', NULL, N'$7.89 billion')
INSERT [dbo].[DEPARTMENTS] ([dept_codes], [Departments], [date_created], [Annual budget], [Field5]) VALUES (7, N'Labor', N'March 4, 1913', NULL, N'$41.7 billion')
INSERT [dbo].[DEPARTMENTS] ([dept_codes], [Departments], [date_created], [Annual budget], [Field5]) VALUES (8, N'Health and Human Services', N'April 11, 1953', NULL, N'$1.394 trillion')
INSERT [dbo].[DEPARTMENTS] ([dept_codes], [Departments], [date_created], [Annual budget], [Field5]) VALUES (9, N'Education', N'October 17, 1979', NULL, N'$72.3 billion')
GO
...
--------вашето решение--------------------
select * from EMPLOYEES where EmployeeID in (select WORK.EmployeeID from WORK where WORK.Pnumber in (Select PROJECTS.Pnumber from PROJECTS where PROJECTS.Location = 'Sofia') group by EmployeeID);
----------------------------------
