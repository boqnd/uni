...
----------------------------------------------------
--Въпрос 6:Напишете SQL заявка, за да намерите служителите, чиито заплати са по-големи от средните заплати на всички служители в отдела 'Justice'.
----------------------------------------------------

use master
go
DROP DATABASE IF EXISTS въпрос_6;
go
create database
въпрос_6
go
...
where EMPLOYEES.dnum=DEPARTMENTS.dept_codes and Salary > (
select AVG(salary)
from EMPLOYEES, DEPARTMENTS
where EMPLOYEES.dnum=DEPARTMENTS.dept_codes and DEPARTMENTS.Departments= 'Justice');
