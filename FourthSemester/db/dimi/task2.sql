...
----------------------------------------------------
--Въпрос 2:Напишете SQL заявка, за да покажете максималната заплата и минималната заплата заедно в една колона от таблицата на служителите?
...
--------вашето решение-------------------
select max(Salary) as t from EMPLOYEES;
